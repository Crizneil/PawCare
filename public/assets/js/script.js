...
-------------------------------------------*/
   ...
   -------------------------------------------*/
    ...
    -------------------------------------------*/
    function handleDashboardSidebar() {
        var sidebar = $("#sidebar");
        var overlay = $("#sidebarOverlay");
        var openBtn = $("#sidebarToggle");
        var closeBtn = $("#closeSidebar");

        if (!openBtn.length) return; // Exit if button doesn't exist on this page
        ...
        openBtn.on("click", function (e) {
            ...
            // Refresh icons in case they didn't load in the hidden sidebar
            lucide.createIcons();
        });
